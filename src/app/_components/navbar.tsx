...
export const Navbar=()=>{
    return(
        ...
        <nav className=" fixed w-full  md:w-9/12 z-40 flex items-center justify-center  p-2 h-16 border rounded-xl bg-[#f7f8fc] shadow-lg" >
<p className="text-xl lg:text-2xl font-bold ">FeedCrunch</p>
